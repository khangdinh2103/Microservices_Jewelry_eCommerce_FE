        ...
        <div className="bg-[#faf7f2] min-h-screen">
            ...
            <div className="container mx-auto px-4 py-4">
                <nav className="flex text-sm">
                    <Link to="/" className="text-amber-600 hover:text-amber-800">Trang chủ</Link>
                    <span className="mx-2 text-amber-600">/</span>
                    {product.categoryName && (
                        <>
                            <Link to={`/catalog/category/${product.categoryId}`} className="text-amber-600 hover:text-amber-800">
                                {product.categoryName}
                            </Link>
                            <span className="mx-2 text-amber-600">/</span>
                        </>
                ...
                <div className="bg-white rounded-2xl shadow-lg p-6 mb-10">
                    <div className="flex flex-col lg:flex-row gap-10">
                        ...
                        <div className="lg:w-1/2">
                            ...
                            >
                                <img 
                                    src={selectedImage || (product.productImages && product.productImages.length > 0 ? product.productImages[0].imageUrl : 'https://via.placeholder.com/600?text=No+Image')}
                                    alt={product.name}
                            ...
                            <div className="space-y-3 text-sm text-amber-800">
                                ...
                                {product.collectionName && (
                                    <div className="flex">
                                        ...
                                        <Link to={`/catalog/collection/${product.collectionId}`} className="text-amber-600 hover:text-amber-800">
                                            {product.collectionName}
                                        </Link>
                                    </div>
                                )}
                    ...
                    <div className="p-6">
                        ...
                        {activeTab === 'description' && (
                            <div className="prose prose-amber max-w-none text-amber-800">
                                ...
                                <p className="mb-4">
                                    Thưởng thức vẻ đẹp tinh tế và sự sang trọng của {product.name} - một kiệt tác từ Tinh Tú Jewelry. 
                                    Được chế tác tỉ mỉ từ {product.material} {product.goldKarat && `${product.goldKarat}K`}, 
                                    sản phẩm này không chỉ là một món trang sức mà còn là biểu tượng của đẳng cấp và phong cách.
                                </p>
                            </div>
                        )}
                                        ...
                                        {productFeatures.length > 0 ? (
                                            productFeatures.map((feature, index) => (
                                                <tr key={index} className="border-b border-amber-100">
                                                    <th className="py-3 text-amber-900 font-medium w-1/3">
                                                        {feature.name}
                                                    </th>
                                            ...
                                            <>
                                                ...
                                                <tr className="border-b border-amber-100">
                                                    ...
                                                    <td className="py-3 text-amber-800">{product.goldKarat ? `${product.goldKarat}K` : 'N/A'}</td>
                                                </tr>
                                                <tr className="border-b border-amber-100">
                                                ...
                                                <tr className="border-b border-amber-100">
                                                    ...
                                                    <td className="py-3 text-amber-800">{product.brand || 'Tinh Tú Jewelry'}</td>
                                                </tr>
                                                <tr>
                        ...
                        {activeTab === 'shipping' && (
                            <div className="text-amber-800 space-y-4">
                                ...
                                <div>
                                    ...
                                    <p>Tất cả sản phẩm tại Tinh Tú Jewelry đều được bảo hành làm sạch và đánh bóng miễn phí trọn đời. Quý khách vui lòng mang sản phẩm đến cửa hàng gần nhất hoặc liên hệ với chúng tôi để được hướng dẫn chi tiết.</p>
                                </div>
                            </div>
                        )}
                    </div>
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                            {similarProducts.slice(0, 4).map((similarProduct) => (
                                ...
                                >
                                    <Link to={`/catalog/product/${similarProduct.id}`} className="block relative">
                                        <div className="aspect-square overflow-hidden">
                                            {similarProduct.productImages && similarProduct.productImages.length > 0 ? (
                                                <img
                                                    src={similarProduct.productImages.find(img => img.isPrimary)?.imageUrl || similarProduct.productImages[0].imageUrl}
                                    ...
                                    <div className="p-4">
                                        <Link to={`/catalog/category/${similarProduct.categoryId}`} className="text-xs text-amber-600 font-medium hover:text-amber-800 transition-colors">
