...
const CategoryPage = () => {
  ...
  const { getCategoryById, getProductsByCategory, loading } = useProduct();
  ...
  useEffect(() => {
    ...
    fetchData();
  }, [id, getCategoryById, getProductsByCategory, searchParams]);
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow bg-white">
        {/* Category Banner */}
        <section className="relative h-[300px] bg-cover bg-center flex items-center justify-center" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1576723417715-89046481ddbe?q=80&w=1000&auto=format&fit=crop')" }}>
            ...
            <div className="w-full md:w-3/4 lg:w-4/5">
              ...
              <div className="flex flex-col sm:flex-row justify-between items-center mb-6">
                ...
                <div className="flex items-center">
                  <label htmlFor="sort" className="mr-2 text-gray-700">Sắp xếp:</label>
                  <select 
                    id="sort"
                        ...
                        {Array.from({ length: totalPages }, (_, i) => i + 1)
                          ...
                          .map((number, index, array) => {
                            ...
                            if (index > 0 && array[index - 1] !== number - 1) {
                              return (
                                <span key={`ellipsis-${number}`} className="px-3 py-2 border-t border-b">
                                  ...
                                </span>
                              );
                            }
