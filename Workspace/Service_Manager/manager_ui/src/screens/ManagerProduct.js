...
import { ShoppingCart, MessageCircle, User, Bell, Search, Twitter, Facebook, Linkedin, Youtube, ArrowRight,ChevronLeft,ChevronRight } from "lucide-react"
  ...
  useEffect(() => {
    ...
    return (
      ...
      <div className="top-bar">
        ...
        <div className="logo">
        <img src={require('../assets/images/logo.png')} alt="TINH TÚ" className="logo-image" />
      ...
      <div>
        <div className="diamond-container">
            ...
            <img src={require('../assets/images/Vector.png')} alt="Diamond Icon" className="diamond-image" />
            <div className="line"></div>
        </div>
      </div>
      ...
      <nav className="main-nav">
        ...
        <div className="search-container">
            <input  type="text" placeholder="Tìm kiếm" className="search-input"  value={searchKeyword}
        ...
        <div className="sort-container">
            <label htmlFor="sortField" className="sort-label">Sắp xếp:</label>
            <select
              id="sortField"
        ...
        <main className="product-grid">
          {products.map((product) => (
            <div key={product.productId} className="product-card">
              <img src={product.imageSet[0]?.imageURL} alt={product.name} className="product-image" />
              ...
              <div className="item-actions">
                ...
                <button className="delete-button"  onClick={() => setProductToDelete(product.productId)}>Xóa</button>
                <button className="stock-button" onClick={() => setProductToUpdateStock(product)}>Nhập kho</button>
              </div>
            </div>
          ))}
